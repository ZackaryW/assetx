...
final Map<String, dynamic> instanceMap = {
  ...
  "assets.folder.foldersub.foldersub2.data": DataX("packages/example/assets/folder/foldersub/foldersub2/data.json"),
  "assets.folder.foldersub.foldersub2.data1": DataX("packages/example/assets/folder/foldersub/foldersub2/data1.json"),
  "assets.folder.foldersub.foldersub2.data2": DataX("packages/example/assets/folder/foldersub/foldersub2/data2.json"),
  "assets.image.image": ImageX("packages/example/assets/image/image.gif"),
  "coolassets.data1.datachild.data": DataX("packages/example/coolassets/data1/datachild/data.json"),
