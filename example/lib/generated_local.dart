...
final Map<String, dynamic> instanceMap = {
  ...
  "assets.folder.foldersub.foldersub2.data": DataX("assets/folder/foldersub/foldersub2/data.json", lazy: false),
  "assets.folder.foldersub.foldersub2.data1": DataX("assets/folder/foldersub/foldersub2/data1.json", lazy: false),
  "assets.folder.foldersub.foldersub2.data2": DataX("assets/folder/foldersub/foldersub2/data2.json", lazy: false),
  "assets.image.image": ImageX("assets/image/image.gif"),
  "coolassets.data1.datachild.data": DataX("coolassets/data1/datachild/data.json", lazy: false),
